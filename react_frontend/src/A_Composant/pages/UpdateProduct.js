...
export default function UpdateProduct(props) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const res = await axios.put(`http://127.0.0.1:8000/api/product/` + param.id, { name,description, price,stock, category_id })
            .then(() => {
                Swal.fire({
                    position: 'top-end',
                    icon: 'success',
                    ...
                    <div className='row vh-100'>
                        ...
                        <div className='col-6  bg-- '>
                            ...
                            <div>
                                ...
                                <input type='text' id='input' value={description} className='form form-control' onChange={(e) => setDescription(e.target.value)} placeholder=' description' />
